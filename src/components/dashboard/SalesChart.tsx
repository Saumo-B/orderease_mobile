...
export function SalesChart({ todayData, yesterdayData }: SalesChartProps) {
  ...
  const cardComponent = (
    <Card className="glass-card border-white/5 h-full group duration-300 cursor-pointer flex flex-col hover:shadow-glow hover:-translate-y-1">
      <CardHeader>
      ...
      <CardContent className="flex-grow flex items-end">
        {hasData ? (
          ...
          <div className="flex flex-col justify-center items-center h-full w-full text-center text-muted-foreground opacity-50">
