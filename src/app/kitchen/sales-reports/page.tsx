...
export default function SalesReportPage() {
  ...
  return (
    <div className="space-y-8">
      <div className="sticky top-0 z-20 bg-background/95 backdrop-blur-sm shadow-[0_4px_20px_-10px_rgba(0,0,0,0.2)] py-4 -mx-4 px-4 md:-mx-8 md:px-8 border-b border-border/40 flex justify-between items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-3">
            <Card className="group bg-card/70 border-border duration-300">
              <CardHeader>
                <CardTitle className="text-foreground group-hover:text-primary transition-colors">Detailed Order History</CardTitle>
              </CardHeader>
              <CardContent>
